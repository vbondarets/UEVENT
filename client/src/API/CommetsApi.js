...
export const createCom = (comment, event_id, user_id) => 
    api.post('http://localhost:8080/api/comment/', {event_id:event_id, comment:comment, user_id: user_id})

export const DeleteCom = (comment_id, user_id) => 
    api.delete(`http://localhost:8080/api/comment/delete/${comment_id}/user/${user_id}`)
